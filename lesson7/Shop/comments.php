...
<body>
    ...
    <div class="container">
        ...
        <div class="comments">
            <form class = "form_user_comment" action="engine/show_comments.php" method = "POST">
                ...
                <div class="submit_reset flex"><input type="submit" name ='submit' value = "Отправить">
                <input type="reset" value = "Сброс"></div>
            </form>
            <div class="flex user_comments"><?php include_once "engine/show_comments.php"?></div>
        </div>  
